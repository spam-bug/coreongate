					...
					<table style="width: 100%">
						<tr>
							<td>
								...
								text-align: center;
								margin: 20px 0px;">
									Welcome to the Coreon Connect Family
								</p>
								...
								margin: 10px 0px ;
								color: #000">
									We're happy to have you on <strong>Coreon Connect</strong>. We can't
									 wait for you to enjoy the unlimited access of our stable, reliable, and 
									 high-speed internet exclusively available for you.
								</p>
							</td>
						</tr>
